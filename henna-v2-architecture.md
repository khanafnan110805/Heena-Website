...
Perfect just need to get things done -
There are some changes or betterment which is needed, i am gonna list them down :

1. On contact page there is a need of some changes needed to be done
2. And on Mehndi Options there is a need of positionning of images also ..
3. And Product sections need to have some pacing
