export const SITE_CONFIG = {
  brand: {
    ...
    artistName: 'Sara',
    artistBio: 'With over a decade of experience in mehndi artistry, Sara blends traditional South Asian techniques with contemporary design sensibilities. Every design is crafted with intention — a personal story told in henna.',
  },
  contact: {
  ...
  seo: {
    ...
    defaultDescription: 'Premium henna and mehndi artist in Mumbai. Specialising in bridal mehndi, Arabic designs, floral patterns, and Indian mehndi. Book via WhatsApp.',
...
export const buildWhatsAppUrl = (message: string, phone: string = SITE_CONFIG.contact.whatsapp): string => {
