...
export function WhatsAppCTA({
  ...
  const baseStyles = `
    ...
    rounded-sm tracking-wide cursor-pointer
  ...
  const filledStyles = `bg-whatsapp text-white hover:brightness-105 active:brightness-95`
  const outlinedStyles = `bg-transparent text-whatsapp border border-whatsapp hover:bg-whatsapp/10`
  ...
  return (
    <a
      ...
      className={`${baseStyles} ${variant === 'filled' ? filledStyles : outlinedStyles} ${pulse ? 'wa-pulse' : ''}`}
