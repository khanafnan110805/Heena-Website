    ...
    <div className="border-b border-border-dark">
      <button
        ...
        className="w-full flex items-center justify-between gap-4 py-5 text-left
                   focus-visible:outline-none focus-visible:text-gold-primary
                   group"
      ...
      >
        ...
        <ChevronDown
          size={18}
          className={`shrink-0 text-gold-muted transition-transform duration-300 ${isOpen ? 'rotate-180 text-gold-primary' : ''}`}
        />
      </button>
